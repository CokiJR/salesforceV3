...
const AddSpecialPricing = () => {
  ...
  const onSubmit = async (values: FormValues) => {
    ...
    try {
      // Check if special pricing already exists for this customer and SKU
      ...
      // Insert new special pricing
      const { error: insertError } = await supabase.from("special_prices").insert({
      ...
      toast({
        title: "Harga khusus berhasil ditambahkan",
        description: "Data harga khusus pelanggan telah berhasil disimpan.",
      });

      navigate("/dashboard/pricing");
    } catch (error: any) {
      console.error("Error adding special pricing:", error.message);
      toast({
        variant: "destructive",
        title: "Error",
        description: `Gagal menyimpan data harga khusus: ${error.message}`,
      });
    } finally {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div className="flex items-center">
        ...
        <h1 className="text-2xl font-bold tracking-tight">Tambah Harga Khusus</h1>
      </div>
                  ...
                  <FormItem className="flex flex-row items-center justify-between rounded-lg border p-3">
                    <div className="space-y-0.5">
                      ...
                      <div className="text-sm text-muted-foreground">
                        Aktifkan atau nonaktifkan harga khusus ini
                      </div>
                    </div>
                    <FormControl>
                      <Switch
...
export default AddSpecialPricing;