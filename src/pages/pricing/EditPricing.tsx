  ...
  const onSubmit = async (values: FormValues) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Data harga produk telah berhasil diperbarui.",
      });
      ...
      toast({
        variant: "destructive",
        title: "Error",
        description: `Gagal memperbarui data harga: ${error.message}`,
      });
    } finally {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div className="flex items-center">
        ...
        <h1 className="text-2xl font-bold tracking-tight">Edit Harga Umum</h1>
      </div>
